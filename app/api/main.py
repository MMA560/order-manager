...
async def delete_product_in_db(product_id: int):
    ...
    #================= Favorites =======================
from app.api.favorite_schemas import *
from app.api.favorite_services import *
@app.post("/order-app/api/v1/favorites/", response_model=FavoriteCreate)
...
@app.get("/order-app/api/v1/favorites/{user_identifier}", response_model=List[ProductOut])
...
@app.post("/clear_one", response_model=bool)
